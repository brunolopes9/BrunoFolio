          ...
          >
            ...
            >
              ...
              <div>
                ...
                <a href="mailto:bruno.lopes9@hotmail.com" className="text-secondary hover:text-primary">
            ...
            >
              ...
              <div>
                ...
                <a href="tel:+351933938716" className="text-secondary hover:text-primary">
                  +(351) 933938716
                </a>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary">Viseu, PT</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
